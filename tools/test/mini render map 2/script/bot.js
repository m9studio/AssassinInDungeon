...
if(layer1[py][px+1]==0){layer1[py+1][px+1]=0;layer1[py][px+1]=24;layer2[py][px+1]=layer2[py+1][px+1];layer2[py+1][px+1]=0;}else
if(layer1[py+1][px]==0){layer1[py+1][px+1]=0;layer1[py+1][px]=23;layer2[py+1][px]=layer2[py+1][px+1];layer2[py+1][px+1]=0;}
drawImage();}

if((layer1[py-1][px-1]>22)&&(layer1[py-1][px-1]<27)){
if(layer1[py][px-1]==0){layer1[py-1][px-1]=0;layer1[py][px-1]=26;layer2[py][px-1]=layer2[py-1][px-1];layer2[py-1][px-1]=0;}else
if(layer1[py-1][px]==0){layer1[py-1][px-1]=0;layer1[py-1][px]=25;layer2[py-1][px]=layer2[py-1][px-1];layer2[py-1][px-1]=0;}
drawImage();}
...
var animation=1;
var timer=setInterval(function(){if(botn1<0){new_bot1()};if(botn2<0){new_bot2()};
...
if(animation%4==0){if(layer1[i][i1]==156){layer1[i][i1]=157}}
if(animation%4==1){if(layer1[i][i1]==157){layer1[i][i1]=156}}
}}animation++;drawImage();
bot();if(player_stop>0){player_stop--}
},500);
