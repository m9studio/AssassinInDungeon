...
inventory[3]=[3,'sword','тяжелый меч I',1,7,3,'s3.png'];
 ...
 inventory[100]=[100,'sword','меч короля крови',1,15000,2500,'s100.png'];
//101-200 броня armor
...
inventory[196]=[196,'armor','шлем короля крови',1,15000,2500,'a96.png'];
inventory[197]=[197,'armor','нагрудник короля крови',2,15000,2500,'a97.png'];
inventory[198]=[198,'armor','перчатки короля крови',3,15000,2500,'a98.png'];
inventory[199]=[199,'armor','штаны короля крови',4,15000,2500,'a99.png'];
inventory[200]=[200,'armor','сапоги короля крови',5,15000,2500,'a100.png'];
